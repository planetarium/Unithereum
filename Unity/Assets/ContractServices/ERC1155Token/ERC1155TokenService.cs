...
using Unithereum.ContractServices.ERC1155Token.ContractDefinition;

namespace Unithereum.ContractServices.ERC1155Token
{
    public partial class ERC1155TokenService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC1155TokenDeployment eRC1155TokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC1155TokenDeployment>().SendRequestAndWaitForReceiptAsync(eRC1155TokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC1155TokenDeployment eRC1155TokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC1155TokenDeployment>().SendRequestAsync(eRC1155TokenDeployment);
        }

        public static async Task<ERC1155TokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC1155TokenDeployment eRC1155TokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eRC1155TokenDeployment, cancellationTokenSource);
            return new ERC1155TokenService(web3, receipt.ContractAddress);
        }
        ...
        public ERC1155TokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public ERC1155TokenService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
