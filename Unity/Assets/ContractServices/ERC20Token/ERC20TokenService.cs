...
using Unithereum.ContractServices.ERC20Token.ContractDefinition;

namespace Unithereum.ContractServices.ERC20Token
{
    public partial class ERC20TokenService
    {
        ...
        public ERC20TokenService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
